...
set PROJECT_NAME=image_resize_sample
set C_FILE_NAME="!SOURCE_FOLDER!win32_image_resize_sample.c"
...
copy /B /Y %~dp0image.png !BUILD_FOLDER! >nul 2>nul
copy /B /Y %~dp0image2.png !BUILD_FOLDER! >nul 2>nul
copy /B /Y %~dp0image3.png !BUILD_FOLDER! >nul 2>nul
